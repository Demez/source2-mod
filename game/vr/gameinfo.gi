"GameInfo"
{
	...
	FileSystem
	{
		SteamAppId				323910		// This will mount all the GCFs we need (240=CS:S, 220=HL2).
		ToolsAppId				323910		// Tools will load this (ie: source SDK caches) to get things like materials\debug, materials\editor, etc.
